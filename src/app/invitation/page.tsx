...
export default function Page() {
  return (
    <main>
      <div className="md:w-[500px] border border-b-0 bg-white mx-auto space-y-32">
        {/* Header */}
        ...
        <div className="px-5 space-y-7">
          <div className="grid grid-cols-6">
            <div className="h-[50px] w-[50px]">
              <Image width={500} height={500} src="/assets/img2.png" className="border h-full w-full object-cover rounded-full" alt="Profile Picture" />
            </div>
        ...
        <footer className="text-sm text-center text-gray-600">
          <p className="pt-20 pb-5">Create with love Kelompok 6 💙</p>
        </footer>
      </div>
    </main>
  );
